...
class KmcFrame(wx.Frame):
    ...
    def InitUI(self):
        ...
        ax1.set_title('Coverage', fontdict={'fontsize': 20})
        ...
        ax3.set_title('Events', fontdict={'fontsize': 20})
        ax3.barh(range(len(event)), count, height=0.5)
        ax3.set_xlabel('count', fontsize=20)
        ax3.set_ylabel('event', fontsize=20)
        ax3.set_xscale('log')
    ...
    def draw_tof(self, inteval, ax):
        ax.set_title('TOF', fontdict={'fontsize': 20})
        ...
        ax.set_ylabel('tof(1/s/site)', fontsize=20)
